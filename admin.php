        ...
        <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
            <div class="container">
                <a class="navbar-brand" href="admin.php">
                    ...
                    <a class="navbar-brand col-sm-3 col-md-1 mr-0 ml-4" href="#">Admin Page</a>
                </a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="update_admin.php?user_id=<?php echo $row['user_id'] ?>"
                                        type="button" class="btn btn-sm btn-success"
                                        style="font-weight: 550;">Update</a>
                                    <a href="delete_user.php?user_id=<?php echo $row['user_id'] ?>" type="button"
                                        class="btn btn-sm btn-danger" style="font-weight: 550;"
