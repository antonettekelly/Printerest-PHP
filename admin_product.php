    ...
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            ?>
                    ...
                    <table class="table table-striped table-hover table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo $row['product_photo'] ?>" style="max-width:100px;" />
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="delete_product.php?product_id=<?php echo $row['product_id'] ?>"
                                        type="button" class="btn btn-sm btn-danger mt-1" style="font-weight: 550;"
                ...
                <a href="add_product.php" type="button" class="btn btn-md btn-primary">Add New Product</a>
            </div>
        </div>
    </div>
    </div>
