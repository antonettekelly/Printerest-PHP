...
<body>
    ...
    <form action="loginad_process.php" method="post" id="logInAdForm" novalidate="">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card mx-5 my-5">
                    ...
                    <div class="text-center mb-4">
                        <button type="submit" class="btn btn-lg btn-secondary" id="logInAdBtn">Login</button>
                        <br>
                        <a class="logcust" href="login_customer.php">Login as Customer</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            $("#logInAdBtn").click(function () {

                //fetch form to apply custom Bootstrap validation
                var form = $("#logInAdForm")
