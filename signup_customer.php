...
<body>
    ...
    <form action="signupcust_process.php" method="post" id="SignUpForm" novalidate="">
        <div class="row">
                ...
                <div class="card mx-5 my-5">
                    <div class="container-box">
                        ...
                        <div class="float-left mt-2 mb-2 mx-5">
                            <a class="nav-link1" href="login_customer.php">Log In</a>
                            <a class="nav-link1" href="#">|</a>
                            <a class="nav-link1 active" href="signup_customer.php">Sign Up</a>
                        </div>
