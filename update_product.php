        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col mt-3">
                    ...
                    <div>
                        <form action="updateproduct_process.php" method="post" enctype="multipart/form-data"
                            id="updateForm" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Category" name="productcategory"
                                    value="<?php echo $row['product_category'] ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <!-- Uploaded image area-->
                                <div class="image-area mt-3 mb-1">
                                    <p class="text-center mt-1">Previous Image</p>
                                    <img src="<?php echo $row['product_photo'] ?>" style="max-width:200px;"
                                        class="img-fluid rounded shadow-sm mx-auto d-block mb-3" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="productdesc"
                                    ...
                                    required><?php echo $row['product_desc'] ?></textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="productsize" required>
                                    <option class="opt"><?php echo $row['product_size'] ?></option>
                                    <option>S</option>
                                    <option>M</option>
                                    <option>L</option>
                                </select>
                            ...
                            <div class="container text-center">
                                <button type="submit" class="btn btn-success" id="updateBtn"
                                    style="font-weight: 550;">Update</button>
